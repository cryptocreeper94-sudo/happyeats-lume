...
First production Lume deployment — restaurant discovery platform built natively in the Lume programming language.

**Live:** [happyeats.tlid.io](https://happyeats.tlid.io)

## Lume-OS Integration

This application is **Lume-native** — built entirely in the Lume programming language. Registered with Lume Cortex.
